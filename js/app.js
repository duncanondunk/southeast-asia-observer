...
(function () {
  ...
  // 标签中英映射
  var TAG_I18N = {
    '中秋': 'Mid-Autumn Festival', '高铁': 'High-Speed Rail', '王室': 'Monarchy', '澳门': 'Macau', '文旅': 'Culture & Tourism', '云南': 'Yunnan', '中国—东盟': 'China–ASEAN', '自贸试验区': 'Free Trade Zone', '绿电': 'Green Power', '新首都': 'New Capital', '海洋': 'Maritime', '电动汽车': 'Electric Vehicle', '防务': 'Defence', '君主立宪': 'Constitutional Monarchy', '竹子外交': 'Bamboo Diplomacy',
    '经济产业': 'Economy & Industry', '国家观察': 'Country Watch', '供应链': 'Supply Chain', '关键矿产': 'Critical Minerals', '量化指数': 'Quantitative Index', '城市': 'Urban', '旅游业': 'Tourism', '产业链': 'Industrial Chain', '金融科技': 'Fintech', 'Grab': 'Grab', 'Atome': 'Atome',
    '地缘政治': 'Geopolitics', '新能源': 'New Energy', '气候变化': 'Climate Change', '俄罗斯': 'Russia', '乌克兰': 'Ukraine', '军事合作': 'Military Cooperation', '边境': 'Border', '领土争端': 'Territorial Dispute', '阿努廷': 'Anutin',
    '水资源': 'Water Resources', '南海': 'South China Sea', '华侨华人': 'Overseas Chinese', '侨务': 'Diaspora Affairs', '华商': 'Overseas Chinese Business', '商会': 'Chamber of Commerce', '体育': 'Sports', '离散叙事': 'Diaspora Narrative', '中餐出海': 'Chinese Cuisine Going Global', '文牧野': 'Wen Muye', '移民': 'Migration', '历史': 'History', '孙中山': 'Sun Yat-sen', '全球': 'Worldwide', '华南': 'South China',
    ...
    '马来西亚': 'Malaysia', '马六甲': 'Malacca', '中马关系': 'China–Malaysia Relations', '尼泊尔': 'Nepal', '缅甸': 'Myanmar', '泰国': 'Thailand', '印尼': 'Indonesia',
    '难民': 'Refugees', '遣返': 'Repatriation', '抗议': 'Protest', '文化遗产': 'Cultural Heritage', '七夕': 'Qixi', '教育': 'Education', '学习危机': 'Learning Crisis',
    '环境': 'Environment', '烟霾': 'Haze', '空气污染': 'Air Pollution', '公共卫生': 'Public Health', '健康': 'Health', '环境治理': 'Environmental Governance', '客家': 'Hakka', '福建': 'Fujian', '韩国': 'South Korea', '中国': 'China', '贸易': 'Trade', '榴莲': 'Durian', '农产品': 'Agriculture', '美国': 'United States', '军事': 'Military', '金眼镜蛇': 'Cobra Gold', '侨乡': 'Qiaoxiang', '广东': 'Guangdong', '灾害': 'Disaster', '地震': 'Earthquake', '海啸': 'Tsunami',     'GDP': 'GDP', 'AI': 'AI', '出口': 'Exports', '一带一路': 'Belt and Road', '基础设施': 'Infrastructure', '铁路': 'Railway', '能源': 'Energy', '水电': 'Hydropower', '天然气': 'Natural Gas',
    ...
    '浙江': 'Zhejiang', '青田': 'Qingtian', '柬埔寨': 'Cambodia', '中柬关系': 'China–Cambodia Relations', '老挝': 'Laos', '侨贸': 'Qiaomao (Overseas-Chinese Trade)', '中印尼关系': 'China–Indonesia Relations', '全面战略伙伴': 'Comprehensive Strategic Partnership', '矿物能源': 'Minerals & Energy', '投资': 'Investment', '柔佛': 'Johor', '经济特区': 'Special Economic Zone', '经济外交': 'Economic Diplomacy',
    ...
    '民主行动党': 'Democratic Action Party (DAP)', '政治': 'Politics', '街头政治': 'Street Politics', '林明达': 'Sondhi Limthongkul', '黄衫军': 'Yellow Shirts', '宪政危机': 'Constitutional Crisis', '弹劾': 'Impeachment', '华人': 'Ethnic Chinese', '族群': 'Ethnicity', '选举': 'Elections', '语言': 'Language', '青年': 'Youth', '青年侨胞': 'Young Overseas Chinese', '华裔新生代': 'New Generation of Chinese Descent',
