...
(function () {
  ...
  var TAG_I18N = {
    ...
    '贫困': 'Poverty', '名人政治': 'Celebrity Politics', '社会治理': 'Social Governance', '外交': 'Diplomacy', '国企': 'State-Owned Enterprise', '华为': 'Huawei', '技术自主': 'Technological Autonomy', '出口管制': 'Export Control', '海底光缆': 'Submarine Cable', '数字基础设施': 'Digital Infrastructure', '数字主权': 'Digital Sovereignty', '社区': 'Community'
  };
